sap.ui.controller("sap.ui.demo.toolpageapp.controller.HRPayroll.EmployeeMgmt.AddDept", {

/**
* Called when a controller is instantiated and its View controls (if available) are already created.
* Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
* @memberOf controller.HRPayroll.EmployeeMgmt.AddDept
*/
	onInit: function() {
...
//	}
	...
	onPress:function(oEvent){
        ...
        var firstnameVal = oSelectedItem.getBindingContext().getProperty("Department");

//		
        this._getDialog().open();
        
        sap.ui.getCore().byId("idFragment14--SNo").setValue(persnoVal);
        sap.ui.getCore().byId("idFragment14--UserType").setValue(firstnameVal);
	 ...
	 _getDialog : function() {
         ...
         if (!this.dialog) {
             ...
             this.dialog = sap.ui.xmlfragment("idFragment14","sap.ui.demo.toolpageapp.view.HRPayroll.EmployeeMgmt.AddDept", this);
             //debugger;
         }	
     ...
     onSave : function(oEvent) {
         ...
         var oPersonInfo = sap.ui.getCore().byId("idFragment14--SNo").getValue();
         var oFirstName = sap.ui.getCore().byId("idFragment14--UserType").getValue();
     ...
     onCreate:function(oEvent){
       ...
       var Course = this.getView().byId("Select").getValue();   
