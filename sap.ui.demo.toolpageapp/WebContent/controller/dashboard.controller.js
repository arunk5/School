sap.ui.define([
	...
	var CController = Controller.extend("sap.ui.demo.toolpageapp.controller.dashboard", {
...
//			});
			...
			var oJSONModel = new JSONModel(jQuery.sap.getModulePath("sap.ui.demo.toolpageapp", "/products.json"));
...
//			this.getView().byId("table").setModel(oJSONModel);
		...
		myown : function (){
			...
			jQuery.ajax({
				type: "GET",
                url : "http://10.2.1./dashboard/products2.php",
                crossDomain: true,	
                data:'courses',
				dataType: "json",
				success: function (oData) {
