...
], function(Controller, SortOrder, Sorter, JSONModel, DateFormat, Fragment, Export, ExportType, ExportTypeCSV) {
	"use strict";
 
	return Controller.extend("sap.ui.demo.toolpageapp.controller.Library.AddCategory", {
...
//			}, this);
		...
		Download: function(oEvent){
			  var sUrl = "/sap/ui/demo/toolpageapp/ProductCollection?$format=xlsx";
