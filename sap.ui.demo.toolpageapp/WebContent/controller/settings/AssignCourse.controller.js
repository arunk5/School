sap.ui.define([
	...
	return Controller.extend("sap.ui.demo.toolpageapp.controller.settings.AssignCourse", {
...
//			
			 ...
			 var model13 = new sap.ui.model.json.JSONModel();
			    ...
			    var dropdown = this.getView().byId("ProductList");   
			    dropdown.setModel(model13);
			
			    var oModel = this.getView().byId("idProductsTable")
			    oModel.setModel(model13);
